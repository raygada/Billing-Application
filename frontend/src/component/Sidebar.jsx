      ...
      <div className="menu-section">
        ...
        <ul>
          ...
          <li className={location.pathname === "/parties" ? "active" : ""}>
            <Link to="/parties">All Customers</Link>
          </li>

         <li className="dropdown-parent">
            {/* Added dropdown-header class */}
            <div className="dropdown-header" onClick={() => setOpenItems(!openItems)}>
              <span>Items</span>
              <span>{openItems ? "▲" : "▼"}</span>
            </div>
            {/* Menu is now INSIDE the li */}
            {openItems && (
              <ul className="dropdown-menu open">
                <li><Link to="/inventory">Inventory</Link></li>
                <li><Link to="/godown">Godown (Warehouse)</Link></li>
              </ul>
            )}
          </li>
         ...
         <li className="dropdown-parent">
         <div className="dropdown-header" onClick={() => setOpenSales(!openSales)}>
              <span>Sales</span>
              <span>{openSales ? "▲" : "▼"}</span>
            </div>
          {openSales && (
          ...
          <li className="dropdown-parent">
             <div className="dropdown-header" onClick={() => setOpenPurchases(!openPurchases)}>
              <span>Purchases</span>
              <span>{openPurchases ? "▲" : "▼"}</span>
            </div>
          {openPurchases && (
            <ul className="dropdown-menu open">
